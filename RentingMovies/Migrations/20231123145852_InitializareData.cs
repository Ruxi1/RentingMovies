...
{
    public partial class InitializareData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdRenting = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IdMovie = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IdClient = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IdClientNavigationIdClient = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IdMovieNavigationIdMovie = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Rentings", x => x.IdRenting);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.IdMovieNavigationIdMovie,
